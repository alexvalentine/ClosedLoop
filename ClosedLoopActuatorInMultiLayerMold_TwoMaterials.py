...
first_layer_bottom = -50.940      # This is the zero registration taken at the bottom of the the first mold layer
start_pos = [477.82, 131.04]                # This is the X, Y start coordinate, which should be +12 mm in X from the left most edge of the mold on it's midline
zero_on_curvature_sensor_matrix = -49.230   # added 2015.10.12, to get the exact height of the curature sensor matrix (wasn't getting good contact with this layer due to squeeging)
